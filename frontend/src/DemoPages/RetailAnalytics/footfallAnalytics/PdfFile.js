...
class App extends React.Component {
  ...
  print = () => {
    ...
    pdf.addImage(this.props.url.first, "PNG", 10, 55, 185.89, 25.28);
    pdf.addImage(this.props.url.second, "PNG", 10, 95, 185.89, 80.28);
    pdf.addPage();
    pdf.text(65, 40, "Weekly Charts OF Different Zones");

    // pdf.addImage(this.props.url.third, "PNG");
    pdf.addImage(this.props.url.third, "PNG", 15, 50, 185.89, 100.28);
    pdf.addPage();
    pdf.text(65, 40, "Weekly/Monthly/Yearly Charts");
    pdf.addImage(this.props.url.fourth, "PNG", 15, 50, 185.89, 110.28);
    ...
    for (var i = 1; i <= pageCount; i++) {
      ...
      pdf.addImage(logo, "PNG", 10, 10, 25, 13);
      pdf.setLineWidth(1.5);
    }
    pdf.setFontSize(14);

    pdf.save("FootfallAnalysis.pdf");
  };
  render() {
