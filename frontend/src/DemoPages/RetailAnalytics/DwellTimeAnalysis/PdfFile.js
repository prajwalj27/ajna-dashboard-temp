...
import DwellTimeAnalysis from "./indexCopied";
...
class App extends React.Component {
  ...
  print = () => {
    const string = renderToString(
      <DwellTimeAnalysis pdfData={this.props.data} />
    );
    // const pdf = new jsPDF("l", "pt", "a4");
    const pdf = new jsPDF("p", "mm", "a4");
    pdf.text(65, 40, "Dwell Time Analysis");
    // x,y,width,height
    pdf.addImage(this.props.url.first, "PNG", 10, 55, 185.89, 23.28);
    pdf.addImage(this.props.url.second, "PNG", 10, 90, 185.89, 70.28);
    // pdf.addPage();
    pdf.addImage(this.props.url.third, "PNG", 10, 180, 185.89, 90.28);
    ...
    pdf.save("dwellTimeAnalysis.pdf");
  };
  render() {
