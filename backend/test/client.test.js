...
describe("Clients API", function () {
  ...
  // 2.Test the Get client by clientId
  describe("Get /api/clients:id", function () {
    ...
    //   // token expiration will return 401 error while testing
    //   chai
    //     .request("http://localhost:4000")
  ...
  describe("POST /api/clients", function () {
    ...
    it("It should post new client", async (done) => {
      const client = {
        name: "rajni",
        email: "rajni@ajna.ai",
        password: "123456",
      ...
      chai
        ...
        .end((err, res) => {
          res.should.have.status(200);
          res.body.should.be.a("object");
          res.body.should.have.property("clientId").eq("abcd");
          res.body.should.have.property("userType").eq("client");
          res.body.should.have.property("email").eq("abcd@gmail.com");
        });
      done();
    });
    it("It should not post as ClientId doesn't exist", async (done) => {
      const client = {
        name: "abcd",
    ...
    it("It should not post as ClientId already exist", async (done) => {
      const client = {
        name: "abcd",
        email: "abcd@gmail.com",
        password: "123456",
        clientId: "faefffbf-9220-404e-9bde-b32ee149f958",
        userType: "client",
        location: "jal",
        contact: "9809890908",
        subscribed: "1 years",
  ...
  describe("DELETE /api/clients/:id", () => {
    // it("It should DELETE an existing client", async (done) => {
    //   const clientId = "abcd";
    //   chai
    //     .request(server)
